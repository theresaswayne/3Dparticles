...
ggsave(paste0(binString,"_nn_density_by_genotype.png"), plot=hist_geno, width=7, height = 7)
ggsave(paste0(binString,"_nn_density_by_treatment.png"), plot=hist_treat, width=7, height = 7)
